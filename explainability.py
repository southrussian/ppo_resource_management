    ...
    messages = [
        {
            ...
            "text": "Ты - интеллектуальная система, которая помогает планировать отправку грузов на складе. "
                    ...
                    "Твоя роль заключается в координации действий агентов, которые анализируют данные, "
                    "поступающие от всех других агентов, и принимают оптимальные решения для планирования отправок грузов.",
        },
        {
            "role": "system",
        ...
        },
        {
            ...
            "text": "Цепочка рассуждений:"
                    "(а) Пожалуйста, определи 1-го агента. "
                    "(б) Затем реконструируй модель BDI 1-го агента. "
                    "(в) Наконец, обобщи поведение 1-го агента. "
                    "Охарактеризуй действия агента (пассивные, активные), "
